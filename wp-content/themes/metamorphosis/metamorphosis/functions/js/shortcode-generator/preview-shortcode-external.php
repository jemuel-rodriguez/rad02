...
$prime_theme_css = get_template_directory_uri() . '/style.css';
$prime_shortcode_css = get_template_directory_uri() . '/functions/css/shortcodes.css';
?>
...
<link rel="stylesheet" href="<?php echo $prime_theme_css; ?>" media="all" />
<link rel="stylesheet" href="<?php echo $prime_shortcode_css; ?>" media="all" />
<style>
...
<?php
	...
	if ( ! in_array( $font, $fonts_whitelist ) ) {
		...
		prime_shortcode_typography_loadgooglefonts( $font );
...
<script type="text/javascript">
    ...
    jQuery('#prime-preview h3:first', window.parent.document).removeClass('prime-loading');
